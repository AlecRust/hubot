...
You can start Hugh locally by running:
...
Then you can interact with Hugh by typing `Hugh help`.

    Hugh> Hugh help
    Hugh animate me <query> - The same thing as `image me`, except adds [snip]
    Hugh help - Displays all of the help commands that Hugh knows about.
    ...
